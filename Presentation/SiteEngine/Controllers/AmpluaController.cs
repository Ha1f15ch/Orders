...
namespace SiteEngine.Controllers
{
    public class AmpluaController : BaseController
    {
        ...
        public AmpluaController(IProfileCustomerRepositories profileCustomerRepositories, IProfilePerformerRepositories profilePerformerRepositories, AppDbContext context)
        {
